...
<section class="bg-white shadow-md p-4 pb-8 flex flex-col gap-4 rounded-md">
  ...
  <div class="text-softDark flex flex-col w-full">
    ...
    <form id="formAddItem" class="w-full h-full">

      <div class="px-7 text-[.9rem] flex flex-col gap-5">
        <div class="flex flex-col">
          <label class="font-bold">Item Name:</label>
          <div class="flex sm:flex-col gap-2">
            <input type="text" name="name" placeholder="e.g: informatique" class="shadow-md p-3 outline-none text-[.9rem] rounded-md">
            <select id="selectCat" name="category_id" class="shadow-md p-3 outline-none text-[.9rem] rounded-md">
        ...
        <div class="flex flex-col w-full">
          ...
          <input type="text" name="title" placeholder="e.g: Informatique" class="shadow-md p-3 outline-none text-[.9rem] rounded-md">
        </div>

        <div class="flex sm:flex-col gap-2">
          <div class="flex flex-col w-full">
            <label class="font-bold">Slug(URL):</label>
            <input type="text" name="slug" placeholder="e.g: informatique-dut" class="shadow-md p-3 outline-none text-[.9rem] rounded-md">
          </div>
          <div class="flex flex-col w-full">
            <label class="font-bold">Meta Title:</label>
            <input type="text" name="meta_title" placeholder="e.g: Informatique | Est-Fes" class="shadow-md p-3 outline-none rounded-md">
          </div>
        </div>
